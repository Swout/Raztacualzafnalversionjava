    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this, "Please write te verification code first...", Toast.LENGTH_SHORT).show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this, "Invalid Phone Number, Please Enter correctly phone number", Toast.LENGTH_SHORT).show();
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(PhoneLoginActivity.this, "Congratulation, you´re logged", Toast.LENGTH_SHORT).show();
